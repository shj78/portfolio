...
#placesList ul {padding-inline-start: 10px !important;}
...
<title>일정 시작 하기</title>
<script>
	function move(keyword)
	{
		location.href='writeplan.action?keyword='+$("#keyword").val();
	}
</script>
<body>
	            ...
	            <div>
	                <form onsubmit="searchPlaces(); return false;" method="post">
	                    ...
	                    <!-- <button type="submit" class="button" onclick="location.href='writeplan.action?';" style=" width: 140px !important; height: 45px!important;   background-color: #fff; border: none!important; border-radius: 45px!important; box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1)!important; cursor: pointer;">일정작성 하기</button>  -->
	                     <button type="submit" class="button" onclick="move(keyword)" style=" width: 140px !important; height: 45px!important;   background-color: #fff; border: none!important; border-radius: 45px!important; box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1)!important; cursor: pointer;">일정작성 하기</button>  
	                    <br>
	                    <br>	                    <br>
	                    <br>
	                	<div style="letter-spacing: 1px; font-stretch:elevation; font-size: 1em !important; text-align: right !important; color: gray; font-weight: 900;">※ 마커를 클릭하세요!</div>
	                </form>
	            </div>
	        </div>
	        <hr>
	        <ul id="placesList" style="padding-inline-start: 0px !important;"></ul>
	        <div id="pagination"></div>
	       	<div id="map" style="display:none; width:1%;height:20%;position:relative;overflow:hidden;"></div>
	        <br>
	        <br>
	        <br>
	    </div>
