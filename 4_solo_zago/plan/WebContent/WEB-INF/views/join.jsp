	...
	<div>
	    ...
	    <div class="bg_white main_container">
	        <div class="center_box">
	            <div class="sign_box">
		            <div class="xxl_title h_color">회원가입</div>
		                <form  method="post">
		                	<div class="input_box">
								<input type="text" class="margin_box" name="username" maxlength="150" required id = "id_username" placeholder="아이디">
								<input type="password" class="margin_box" name="password" maxlength="128" required id = "id_password1" placeholder="비밀번호">
								<input type="password" class="margin_box" name="password" maxlength="128" required id = "id_password2" placeholder="비밀번호확인">

								<input type="text" class="margin_box" name="nickname" maxlength="100" required id = "id_nickname" placeholder="닉네임">
								<input type="email" class="margin_box" name="email" maxlength="254" required id = "id_email" placeholder="이메일">
								
							</div>
		                    <button type="submit" class="sign_btn" style="letter-spacing: 1px; color:black; cursor: pointer!important;">회원가입</button> 
		                	...
		                	<div style="letter-spacing: 1px;  font-size: 14px!important; text-align: center !important; color: gray;     padding: 10px;">이미 회원이신가요? <a href="" style="color: black!important; text-decoration: none;">로그인하기</a></div>
	                </form>
	            </div>
	        </div>
